    ...
    return (
        <div className="flex justify-center items-center pb-40">
            <div className="flex flex-col items-center mt-16">
                <h3 className=" font-bold text-[80px] font-grand mt-4">Subscribe</h3>
                <p className="text-center text-[24px] w-[40%]">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Animi quam eveniet excepturi asperiores.</p>
